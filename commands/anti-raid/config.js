...
.setThumbnail(message.author.displayAvatarURL({ dynamic: true }))
    ...
    .setFooter(message.guild.name + " | made by POWER DZ#0303", message.guild.iconURL())
...
.setThumbnail(message.author.displayAvatarURL({ dynamic: true }))
.setFooter(message.guild.name + " | made by Nangyal#8173 | A Whole remake of the bot made by Nangyal#8173", message.guild.iconURL())
